use security_disclaimers::{SecurityLevel, DisclaimerCategory, SecurityDisclaimer, security_disclaimer};
use soroban_sdk::Env;
...
fn test_audit_disclaimers() {
    ...
    let critical_audit = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Critical, DisclaimerCategory::Audit);
    let high_audit = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::High, DisclaimerCategory::Audit);
    let medium_audit = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Medium, DisclaimerCategory::Audit);
    let low_audit = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Low, DisclaimerCategory::Audit);
...
fn test_usage_disclaimers() {
    ...
    let critical_usage = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Critical, DisclaimerCategory::Usage);
    let high_usage = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::High, DisclaimerCategory::Usage);
...
fn test_upgrade_disclaimers() {
    ...
    let critical_upgrade = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Critical, DisclaimerCategory::Upgrade);
    let high_upgrade = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::High, DisclaimerCategory::Upgrade);
    let medium_upgrade = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Medium, DisclaimerCategory::Upgrade);
    let low_upgrade = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Low, DisclaimerCategory::Upgrade);
...
fn test_emergency_disclaimers() {
    ...
    let emergency = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Critical, DisclaimerCategory::Emergency);
    ...
    let emergency_medium = SecurityDisclaimer::get_disclaimer(env.clone(), SecurityLevel::Medium, DisclaimerCategory::Emergency);
...
fn test_testing_requirements() {
    ...
    let critical_reqs = SecurityDisclaimer::get_testing_requirements(env.clone(), SecurityLevel::Critical);
    let high_reqs = SecurityDisclaimer::get_testing_requirements(env.clone(), SecurityLevel::High);
    let medium_reqs = SecurityDisclaimer::get_testing_requirements(env.clone(), SecurityLevel::Medium);
